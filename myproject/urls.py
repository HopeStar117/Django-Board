...
urlpatterns = [
    # url(r'^$', views.home, name='home'), #call function based view
    url(r'^$', views.BoardListView.as_view(), name='home'),#call class based view
    ...
    # url(r'^boards/(?P<pk>\d+)/$', views.board_topics, name='board_topics'), #call function based view
    url(r'^boards/(?P<pk>\d+)/$', views.TopicListView.as_view(), name='board_topics'), #call class based view
